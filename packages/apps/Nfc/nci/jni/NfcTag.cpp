...
typedef struct eZlink{
    int mEzTechParams;
    int mEzsel_rsp;
    int mEzTechLibNfcTypes;
} eZlink_t;
eZlink_t meZlink;
    ...
    mIsFelicaLite(false)
{
    ...
    memset(&meZlink , 0, sizeof(eZlink_t));
}
...
**
*******************************************************************************/
void NfcTag::storeEzlinkType()
{
    static const char fn [] = "NfcTag::storeEzlinkType";
    meZlink.mEzTechParams = mTechParams[0].mode;
    meZlink.mEzTechLibNfcTypes = mTechLibNfcTypes [0];
}
/*******************************************************************************
**
...
**
*******************************************************************************/
bool NfcTag::isEzLinkType ()
{
    static const char fn [] = "NfcTag::isEzLinkType";
    bool retval = false;
    if ((meZlink.mEzTechParams == NFC_DISCOVERY_TYPE_POLL_B) &&
            meZlink.mEzTechLibNfcTypes == NFA_PROTOCOL_ISO_DEP)
    {
        retval = true;
    }
    ALOGD ("%s: return=%u", fn, retval);
